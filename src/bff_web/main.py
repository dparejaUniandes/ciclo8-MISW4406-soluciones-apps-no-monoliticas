...
settings = Config()
app_configs: dict[str, Any] = {"title": "BFF-Web"}
...
async def app_startup():
    global tasks
    global eventos
    # task1 = asyncio.ensure_future(suscribirse_a_topico("eventos-cliente", "saludtech-bff", "public/default/eventos-cliente", eventos=eventos))
    # tasks.append(task1)
